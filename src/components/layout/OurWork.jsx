...
const OurWork = () => {
  ...
  return (
    <div
      className="relative"
      style={{
        backgroundColor: isInViewport ? "#050917" : "#f8f8f8",
          ...
          <div className={`popup mx-5  lg:mx-28 font-nunito  `}>
            <div className="flex flex-col pt-10 lg:pt-0 lg:flex-row relative ">
              ...
              <div className="mt-5 lg:mt-0 lg:ml-5 lg:mr-20">
                <p className="text-[34px] font-semibold multiverse-text">
                  {selectedWork.title}
                </p>
                <p className="text-[18px]">{selectedWork.popUpdescription}</p>
              </div>
            </div>
            <p className="font-bold text-[48px] mt-10">
              Website Design & Mockup
            </p>
            <img src={selectedWork.image1} alt="" className="mt-3 w-full" />
            <img src={selectedWork.image2} alt="" className="mt-12 w-full" />
            <img src={selectedWork.image3} alt="" className="mt-12 w-full" />
          </div>
        </div>
      )}
    </div>
